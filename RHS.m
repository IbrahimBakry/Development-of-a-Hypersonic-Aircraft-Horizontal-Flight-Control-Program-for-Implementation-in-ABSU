% ********************************************************
% Sub Program: The Right Hand Sides of the Differential 
...
% %%% Limits
% if u1>=1900, u1=1900; end
% if h1>=6418, h1=6418; end
% if h1<=6398, h1=6398; end
% %%% End Limits

[Maero,Vabs,Mg,alfa,beta]= matrices(u1,v1,w1,phis1,thetas1,psis1);
% %%% Limits
% if alfa>=30*(3.14/180), alfa=30*(3.14/180); end
% if alfa<=-20*(3.14/180), alfa=-20*(3.14/180); end
% if beta>=5*(3.14/180), beta=5*(3.14/180); end
% if beta<=-5*(3.14/180), beta=-5*(3.14/180); end
% %%% End Limits
...
% ***************************************************************
dydt=X;              % u, v, w, pl, ql, rl

dydt(7)  = phis1p;   % phi'
dydt(8)  = thetas1p; % theta'
dydt(9)  = psis1p;   % psi'
dydt(10) = h1p;      
dydt(11) = phi1p;
dydt(12) = theta1p;  
